module.exports = [
"[project]/src/lib/amount-words.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/lib/insights.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useReminders() {
    const { data, t, lang } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useApp"])();
    ...
    for (const r of data.reminders){
        ...
        const when = mins < 0 ? t("reminderOverdue") : mins < 60 ? `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toBnDigits"])(mins)} ${t("minutesLeft")}` : `${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fmtDate"])(r.dueAt, lang)} · ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fmtTime"])(r.dueAt, lang)}`;
    ...
    for (const doc of data.documents){
        const days = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["daysUntil"])(doc.expiryDate);
        if (days > 30) continue;
    ...
    for (const c of data.customers){
        ...
        out.push({
            id: `due-${c.id}`,
            group: "payments",
            message: `${c.name} — ${t("moneyDue")} ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fmtMoney"])(c.due, lang)}`,
    ...
    for (const d of data.drivers){
        const days = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$types$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["daysUntil"])(d.licenseExpiry);
    ...
    for (const tr of data.trips){
        ...
        out.push({
            id: `trip-${tr.id}`,
            group: "trips",
            message: `${label} ${(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["fmtTime"])(tr.startAt, lang)} — ${v?.name} · ${tr.from} → ${tr.to}`,
...
function toBn(n, lang) {
    return lang === "bn" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$format$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toBnDigits"])(n) : String(n);
}
...
function useMileageWarnings() {
    const { data, t } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$store$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useApp"])();
...
"[project]/src/lib/install-prompt.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useInstallPrompt = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])()((set, get)=>({
        canInstall: false,
        standalone: false,
        isIOS: false,
        dismissed: false,
...
"[project]/src/lib/lucide-compat.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createIcon(name) {
    function CompatIcon({ className, strokeWidth, size, style, ...rest }) {
        ...
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            ...
            translate: "no",
            "data-icon": name,
            className: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["cn"])("ms-icon", className),
            style: {
                ...px !== undefined ? {
                    fontSize: `${px}px`
                } : null,
...
const BOTTOM_NAV = MODULES.filter((m)=>[
        "dashboard",
        "trips",
        "vehicles"
    ].includes(m.id));
...
"[project]/src/lib/share.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=src_lib_1puquqr._.js.map