 ...
 */ const Toaster = ({ ...props })=>{
    ...
    const hostRef = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"](null);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "Toaster.useEffect": ()=>{
                ...
                "Toaster.useEffect": (records)=>{
                    for (const rec of records){
                        for (const node of rec.addedNodes){
                            ...
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$notify$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["attention"])(type === "error" ? "error" : "success");
                        }
                    }
                }
            }["Toaster.useEffect"]);
            ...
            return ({
                "Toaster.useEffect": ()=>mo.disconnect()
            })["Toaster.useEffect"];
        }
    }["Toaster.useEffect"], []);
...
_s(Toaster, "By/t4uBmaMvs1XRiQKKH7U2FDeo=", false, function() {
    return [
...
function chime(kind) {
    try {
        const AC = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : window.AudioContext ?? window.webkitAudioContext;
        if (!AC) return;
...
//# sourceMappingURL=src_020jaxs._.js.map